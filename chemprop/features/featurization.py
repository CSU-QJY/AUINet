...
def atom_features(atom: Chem.rdchem.Atom, mol: Chem.rdchem.Mol = None, functional_groups: List[int] = None) -> List[
...
class MolGraph:
    ...
    def __init__(self, smiles: str, args: Namespace):
        ...
        self.uq_out = False
        out_smiles = ['[H]C([H])([H])C1([H])OC([H])([H])C2(C([H])([H])C2([H])[H])C1([H])[H]',
                      '[H]C1([H])OC([H])([H])C2(C1([H])[H])C([H])([H])C2([H])[H]',
                      '[H]C([H])([H])C1([H])C([H])([H])C12C([H])([H])OC([H])([H])C2([H])[H]',
                      '[H]OC1([H])C([H])([H])C12C([H])([H])OC([H])([H])C2([H])[H]',
                      '[H]C([H])([H])C1([H])C([H])([H])OC([H])([H])C12C([H])([H])C2([H])[H]',
                      'Oc1c(Cl)cccc1Cl']

        # Convert identifiers to molecule
        mol = Chem.MolFromSmiles(smiles)
        if smiles in out_smiles:
            self.uq_out = True
...
class BatchMolGraph:
    ...
    def __init__(self, mol_graphs: List[MolGraph], args: Namespace):
        ...
        self.uq_out = [mol_graph.uq_out for mol_graph in mol_graphs]
