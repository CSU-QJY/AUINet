...
MoleculeDataset]:
    ...
    if balanced:  # Put stuff that's bigger than half the val/test size into train, rest just order randomly
        ...
        print(f'len of big_index_sets: {len(big_index_sets)} len of small_index_sets: {len(small_index_sets)}')
    ...
    return MoleculeDataset(train), MoleculeDataset(test),MoleculeDataset(val)
...
def log_scaffold_stats(data: MoleculeDataset,
    ...
    print(
        'Label averages per scaffold, in decreasing order of scaffold frequency,'f'capped at {num_scaffolds} scaffolds and {num_labels} labels: {stats}')
