...
Note that the requirements.txt file does not contain the command to install pytorch and cuda, you need to run the following command to install it separately:

    $ python pip install torch==2.2.2 torchvision==0.17.2 torchaudio==2.2.2 --index-url https://download.pytorch.org/whl/cu121
